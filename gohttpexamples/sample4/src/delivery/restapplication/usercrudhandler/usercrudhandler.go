...
func (p *UserCrudHandler) Put(r *http.Request) resputl.SrvcRes {
	...
	return resputl.Response200OK(&UserUpdateRespDTO{ID: userObj.ID})
...
func (p *UserCrudHandler) Delete(r *http.Request) resputl.SrvcRes {
	...
	var requestdata *UserDeleteDTO
	err = json.Unmarshal(body, &requestdata)
	if err != nil {
		resputl.SimpleBadRequest("Error unmarshalling Data")
	}
	err =p.usersvc.Delete(requestdata.ID)
	if err != nil {
	...
	return resputl.Response200OK(&UserDeleteRespDTO{ID: requestdata.ID})
